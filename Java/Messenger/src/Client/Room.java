...
try {
    connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/newMess", "root", "");
    preparedStatement = connection.prepareStatement("UPDATE newMess.User SET fullName = ?, email = ?, phoneNo = ?, gender = ?");
    preparedStatement.setString(1, String.valueOf(fullName));
    preparedStatement.setString(2, String.valueOf(email));
    preparedStatement.setString(3, String.valueOf(phoneNo));
    ...
    public void send() {
        ...
        try {
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/newMess", "root", "");
            preparedStatement = connection.prepareStatement("INSERT INTO newMess.messages (messageBody, userId_FK) values ()");
            preparedStatement.setString(1, String.valueOf(fullName));
            preparedStatement.setString(2, String.valueOf(email));
            preparedStatement.setString(3, String.valueOf(phoneNo));
            preparedStatement.setString(4, String.valueOf(gender));
